        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::model($user, ['url' => route('user_update_path', ['id' => $user->id]), 'method' => 'PATCH', 'id' => 'updateUserForm']) !!}
                            {!! Form::hidden('id', $user->id) !!}
                            @include('user._form', ['formTitle' => 'Update User', 'roleId' => $user->role_id, 'submitButtonText' => 'Update User'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
