    ...
    <header id="topbar">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-active">
                    <a href="{{ route('school_list_path') }}">School</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::model($school, ['url' => route('school_update_path', ['id' => $school->id]), 'method' => 'PATCH', 'id' => 'updateSchoolForm']) !!}
                            {!! Form::hidden('id', $school->id) !!}
                            @include('school._form', ['formTitle' => 'Edit School', 'submitButtonText' => 'Update School'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
