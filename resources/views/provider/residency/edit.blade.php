    ...
    <header id="topbar">
        <div class="topbar-left">`
            <ol class="breadcrumb">
                ...
                <li class="crumb-active">
                    <a href="{{ route('professional_residency_list_path', ['professional_id' => $residency->professional_id]) }}">Residencies</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::model($residency, ['url' => route('professional_residency_update_path', ['id' => $residency->id]), 'method' => 'PATCH', 'id' => 'updateForm']) !!}
                            {!! Form::hidden('id', $residency->id) !!}
                            {!! Form::hidden('professional_id', $residency->professional_id) !!}
                            @include('provider.residency._form', ['formTitle' => 'Update Residency', 'submitButtonText' => 'Update Residency'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function(){
            ...
            $('#cancel-button').click(function(ev){
                ev.preventDefault();
                window.location = "{{ route('professional_residency_list_path', ['professional_id' => $residency->professional_id]) }}";
            });
