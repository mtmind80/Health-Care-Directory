        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::open(['route' => 'provider_malpractice_store_path', 'id' => 'createForm']) !!}
                            {!! Form::hidden('provider_id', $provider_id) !!}
                            @include('provider.malpractice._form', ['formTitle' => 'Add Malpractice', 'submitButtonText' => 'Add Malpractice', 'create' => true])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
