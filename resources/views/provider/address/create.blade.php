    ...
    <header id="topbar">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-active">
                    <a href="{{ route('provider_address_list_path', ['provider_id' => $provider_id]) }}">Addresses</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::open(['route' => 'provider_address_store_path', 'id' => 'createForm']) !!}
                            {!! Form::hidden('provider_id', $provider_id) !!}
                            @include('provider.address._form', ['formTitle' => 'New Address', 'submitButtonText' => 'Add Address', 'create' => true])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function(){
            ...
            $('#cancel-button').click(function(ev){
                ev.preventDefault();
                window.location = "{{ route('provider_address_list_path', ['provider_id' => $provider_id]) }}";
            });
