        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::open(['route' => 'insurer_store_path', 'id' => 'createInsurerForm']) !!}
                            @include('insurer._form', ['formTitle' => 'New Insurer', 'submitButtonText' => 'Create Insurer', 'create' => true])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
