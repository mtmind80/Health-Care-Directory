<div class="panel-body">
    ...
    <div class="section row">
        <div class="col-sm-6">
            {{ Form::jSelect('country_id', $countriesCB, ['selected' => empty($create) ? $insurer->state->country->id : 0, 'label' => 'Country', 'required' => true, 'class' => '', 'iconClass' => 'fa fa-globe', 'attributes' => ['id' => 'country_id',]]) }}
        </div>
        <div class="col-sm-6">
            {{ Form::jSelect('state_id', $statesCB, ['selected' => empty($create) ? $insurer->state->id : 0, 'label' => 'State', 'hint' => '(Select Country first)', 'required' => true, 'class' => '', 'iconClass' => 'fa fa-tree', 'attributes' => ['id' => 'state_id',]]) }}
        </div>
    </div>
