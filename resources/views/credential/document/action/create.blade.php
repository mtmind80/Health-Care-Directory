        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::open(['route' => 'credential_document_action_store_path', 'id' => 'createForm']) !!}
                        {!! Form::hidden('document_id', $document_id) !!}
                        @include('credential.document.action._form', ['formTitle' => 'Add Document Action', 'submitButtonText' => 'Add Document Action', 'create' => true])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
