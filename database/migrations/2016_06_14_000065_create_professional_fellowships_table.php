...
class CreateProfessionalFellowshipsTable extends Migration {
	...
	public function up()
	{
		Schema::create('professional_fellowships', function(Blueprint $table) {
            $table->increments('id');
	...
	{
		Schema::drop('professional_fellowships');
	}
