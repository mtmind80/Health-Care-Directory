...
class ProfessionalResidency extends BaseModel
{
    ...
    public $sortable = [
        'speciality_types.name|professional_residencies.speciality_type_id',
        'speciality_subtypes.name|professional_residencies.speciality_subtype_id',
        'degrees.name|professional_residencies.degree_id',
        'disciplines.name|professional_residencies.discipline_id',
        'facilities.name|professional_residencies.facility_id',
    ];
