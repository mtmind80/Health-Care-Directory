...
class ProviderMalpracticeJudgementObserver
{

    protected $comment = 'Provider Malpractice Judgement';
    ...
    public function created($model)
    {
        ...
        Event::fire(new ProviderHasChanged($model->malpractice->provider_id, 1, \Auth::user()->id, $jsonData, $this->comment));
    }
    ...
    public function updating($model)
    {
        ...
        Event::fire(new ProviderHasChanged($model->malpractice->provider_id, $actionId, \Auth::user()->id, $jsonData, $this->comment));
    }
