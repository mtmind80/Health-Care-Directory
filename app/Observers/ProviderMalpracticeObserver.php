...
class ProviderMalpracticeObserver
{

    protected $comment = 'Provider Malpractice';
    ...
    public function created($model)
    {
        ...
        Event::fire(new ProviderHasChanged($model->provider_id, 1, \Auth::user()->id, $jsonData, $this->comment));
    }
    ...
    public function updating($model)
    {
        ...
        Event::fire(new ProviderHasChanged($model->provider_id, $actionId, \Auth::user()->id, $jsonData, $this->comment));
    }
