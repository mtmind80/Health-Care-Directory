...
(function ($) {
    ...
    FullName.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-fullname"><label><span>First Name: </span><input type="text" name="first_name" class="input-small"></label></div>'+
             '<div class="editable-fullname"><label><span>Last Name: </span><input type="text" name="last_name" class="input-small"></label></div>',
        inputclass: ''
    });
